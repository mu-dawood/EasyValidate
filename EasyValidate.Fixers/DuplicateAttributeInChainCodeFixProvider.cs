...
{
    /// <summary>
    /// Code fix provider for DuplicateAttributeInChainProcessor (EASY009).
    /// Provides automatic fixes for duplicate attributes in a chain by adding unique chain names.
    /// </summary>
