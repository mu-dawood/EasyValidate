...
public class NegativeSimpleTests
{
    ...
    public void IntValue_WithVariousNegativeNumbers_ShouldReturnValid(int value)
    {
        ...
        // Assert
        Assert.True(result.IsValid());
        Assert.DoesNotContain(result.Errors, e => e.Path.Contains("IntValue"));
    }
    ...
    public void DoubleValue_WithNegativeNumbers_ShouldReturnValid(double value)
    {
        ...
        // Assert
        Assert.True(result.IsValid());
        Assert.DoesNotContain(result.Errors, e => e.Path.Contains("DoubleValue"));
    }
    ...
    public void DoubleValue_WithNonNegativeNumbers_ShouldReturnInvalid(double value)
    {
        ...
        // Assert
        Assert.False(result.IsValid());
        Assert.Contains(result.Errors, e => e.Path.Contains("DoubleValue"));
    }
    ...
    public void DecimalPrecision_ShouldBeHandledCorrectly()
    {
        ...
        // Assert
        Assert.True(result.IsValid());
        Assert.DoesNotContain(result.Errors, e => e.Path.Contains("DecimalValue"));
    }
    ...
    public void FloatMinValue_ShouldBeValid()
    {
        ...
        // Assert
        Assert.True(result.IsValid());
        Assert.DoesNotContain(result.Errors, e => e.Path.Contains("FloatValue"));
    }
    ...
    public void LongMinValue_ShouldBeValid()
    {
        ...
        // Assert
        Assert.True(result.IsValid());
        Assert.DoesNotContain(result.Errors, e => e.Path.Contains("LongValue"));
    }
}
