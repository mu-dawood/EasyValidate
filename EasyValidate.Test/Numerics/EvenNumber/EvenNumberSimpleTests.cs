...
public class EvenNumberSimpleTests
{
    ...
    public void OddIntValue_ShouldReturnInvalid()
    {
        ...
        Assert.Contains(result.Errors, e => e.Path.Contains("IntValue"));
    }
    ...
    public void IntValue_WithEvenNumbers_ShouldReturnValid(int value)
    {
        ...
        // Assert
        Assert.True(result.IsValid() || !result.Errors.Any(e => e.Path.Contains("IntValue")));
    }
    ...
    public void LongValue_WithEvenNumbers_ShouldReturnValid(long value)
    {
        ...
        // Assert
        Assert.True(result.IsValid() || !result.Errors.Any(e => e.Path.Contains("LongValue")));
    }
    ...
    public void LongValue_WithOddNumbers_ShouldReturnInvalid(long value)
    {
        ...
        // Assert
        Assert.False(result.IsValid());
        Assert.Contains(result.Errors, e => e.Path.Contains("LongValue"));
    }
    ...
    public void NullableInt_WithOddValue_ShouldReturnInvalid()
    {
        ...
        Assert.False(result.IsValid());
        Assert.True(result.HasErrors());
        Assert.Contains(result.Errors, e => e.Path.Contains("NullableInt"));
    }
    ...
    public void ShortValue_WithEvenNumbers_ShouldReturnValid(short value)
    {
        ...
        // Assert
        Assert.True(result.IsValid() || !result.Errors.Any(e => e.Path.Contains("ShortValue")));
    }
    ...
    public void ByteValue_WithEvenNumbers_ShouldReturnValid(byte value)
    {
        ...
        // Assert
        Assert.True(result.IsValid() || !result.Errors.Any(e => e.Path.Contains("ByteValue")));
    }
    ...
    public void ByteValue_WithOddNumbers_ShouldReturnInvalid(byte value)
    {
        ...
        // Assert
        Assert.False(result.IsValid());
        Assert.Contains(result.Errors, e => e.Path.Contains("ByteValue"));
    }
    ...
    public void NegativeEvenNumbers_ShouldReturnValid()
    {
        ...
        // Assert
        Assert.True(result.IsValid() || !result.Errors.Any(e => e.Path.Contains("IntValue") || e.Path.Contains("LongValue") || e.Path.Contains("ShortValue") || e.Path.Contains("NullableInt")));
    }
