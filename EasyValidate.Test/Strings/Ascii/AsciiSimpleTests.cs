...
public class AsciiSimpleTests
{
    ...
    public void Ascii_InvalidNonAsciiString_ReturnsInvalidResult()
    {
        ...
        Assert.Contains(result.Errors, e => e.Path.Contains(nameof(model.Text)));
        Assert.DoesNotContain(result.Errors, e => e.Path.Contains(nameof(model.Description)));
        Assert.DoesNotContain(result.Errors, e => e.Path.Contains(nameof(model.Content)));
        var textErrors = result.Errors.Where(e => e.Path.Contains(nameof(model.Text))).ToList();
