...
public class UppercaseSimpleTests
{
    ...
    public void Uppercase_InvalidLowercaseString_ReturnsInvalidResult()
    {
        ...
        Assert.Contains(result.Errors, e => e.Path.Contains(nameof(model.Title)));
        Assert.DoesNotContain(result.Errors, e => e.Path.Contains(nameof(model.Code)));
        Assert.DoesNotContain(result.Errors, e => e.Path.Contains(nameof(model.Category)));
        var titleErrors = result.Errors.Where(e => e.Path.Contains(nameof(model.Title))).ToList();
    ...
    [Fact]
    public void Uppercase_EmptyString_ReturnsInvalidResult()
    {
        // Arrange
        var model = new UppercaseModel
        {
