...
public class EqualToSimpleTests
{
    ...
    public void StringProperty_WithWrongValue_ShouldReturnInvalid()
    {
        ...
        Assert.Contains(result.Errors, e => e.Path.Contains("StringProperty"));
    }
    ...
    public void IntProperty_WithWrongValue_ShouldReturnInvalid()
    {
        ...
        Assert.False(result.IsValid());
        Assert.True(result.HasErrors());
        Assert.Contains(result.Errors, e => e.Path.Contains("IntProperty"));
    }
    ...
    public void DoubleProperty_WithWrongValue_ShouldReturnInvalid()
    {
        ...
        Assert.False(result.IsValid());
        Assert.True(result.HasErrors());
        Assert.Contains(result.Errors, e => e.Path.Contains("DoubleProperty"));
    }
    ...
    public void BoolProperty_WithWrongValue_ShouldReturnInvalid()
    {
        ...
        Assert.False(result.IsValid());
        Assert.True(result.HasErrors());
        Assert.Contains(result.Errors, e => e.Path.Contains("BoolProperty"));
    }
    ...
    public void NullableProperty_WithNonNullValue_ShouldReturnInvalid()
    {
        ...
        Assert.False(result.IsValid());
        Assert.True(result.HasErrors());
        Assert.Contains(result.Errors, e => e.Path.Contains("NullableProperty"));
    }

    [Theory]
    [InlineData("ExpectedValue")]
    [InlineData("ExpectedValue")] // Duplicate to test consistency
    public void StringProperty_WithExactMatch_ShouldReturnValid(string value)
    {
        ...
        // Assert
        Assert.True(result.IsValid() || !result.Errors.Any(e => e.Path.Contains("StringProperty")));
    }
    ...
    public void IntProperty_WithExactMatch_ShouldReturnValid(int value)
    {
        ...
        // Assert
        Assert.True(result.IsValid() || !result.Errors.Any(e => e.Path.Contains("IntProperty")));
    }
    ...
    public void BoolProperty_ComparedAgainstTrue_ShouldWorkCorrectly(bool value)
    {
        ...
        if (value == true)
        {
            Assert.True(result.IsValid() || !result.Errors.Any(e => e.Path.Contains("BoolProperty")));
        }
        else
        {
            Assert.False(result.IsValid());
