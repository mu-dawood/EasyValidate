...
public class PastDateSimpleTests
{
    ...
    public void FutureEventDate_ShouldReturnInvalid()
    {
        ...
        Assert.Contains(result.Errors, e => e.Path.Contains("EventDate"));
    }
    ...
    public void EventDate_WithVariousPastDays_ShouldReturnValid(int daysAgo)
    {
        ...
        // Assert
        Assert.True(result.IsValid() || !result.Errors.Any(e => e.Path.Contains("EventDate")));
    }
    ...
    public void DateOnly_WithPastDate_ShouldReturnValid()
    {
        ...
        // Assert
        Assert.True(result.IsValid() || !result.Errors.Any(e => e.Path.Contains("BirthDate")));
    }
    ...
    public void DateOnly_WithFutureDate_ShouldReturnInvalid()
    {
        ...
        // Assert
        Assert.False(result.IsValid());
        Assert.Contains(result.Errors, e => e.Path.Contains("BirthDate"));
    }
    ...
    public void DateTimeOffset_WithPastDate_ShouldReturnValid()
    {
        ...
        // Assert
        Assert.True(result.IsValid() || !result.Errors.Any(e => e.Path.Contains("CreatedAt")));
    }
    ...
    public void DateTimeOffset_WithFutureDate_ShouldReturnInvalid()
    {
        ...
        // Assert
        Assert.False(result.IsValid());
        Assert.Contains(result.Errors, e => e.Path.Contains("CreatedAt"));
    }
