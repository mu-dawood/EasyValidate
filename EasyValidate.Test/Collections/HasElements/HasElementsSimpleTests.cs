...
public class HasElementsSimpleTests
{
    ...
    public void EmptyStringList_ShouldReturnInvalid()
    {
        ...
        Assert.Contains(result.Errors, e => e.Path.Contains("StringList"));
    }
    ...
    public void EmptyArray_ShouldReturnInvalid()
    {
        ...
        Assert.False(result.IsValid());
        Assert.True(result.HasErrors());
        Assert.Contains(result.Errors, e => e.Path.Contains("StringArray"));
    }
    ...
    public void EmptyHashSet_ShouldReturnInvalid()
    {
        ...
        Assert.False(result.IsValid());
        Assert.True(result.HasErrors());
        Assert.Contains(result.Errors, e => e.Path.Contains("GuidHashSet"));
    }
    ...
    public void StringList_WithVariousElementCounts_ShouldReturnValid(int elementCount)
    {
        ...
        // Assert
        Assert.True(result.IsValid() || !result.Errors.Any(e => e.Path.Contains("StringList")));
    }
    ...
    public void EnumerableWithYield_ShouldWork()
    {
        ...
        // Assert
        Assert.True(result.IsValid() || !result.Errors.Any(e => e.Path.Contains("NumberEnumerable")));
    }
    ...
    public void CollectionWithNullElements_ShouldStillBeValid()
    {
        ...
        // Assert
        Assert.True(result.IsValid() || (!result.Errors.Any(e => e.Path.Contains("StringList")) && !result.Errors.Any(e => e.Path.Contains("ObjectCollection"))));
    }
