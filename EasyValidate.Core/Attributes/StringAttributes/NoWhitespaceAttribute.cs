...
namespace EasyValidate.Core.Attributes
{
    ...
    {
        private static readonly Lazy<NoWhitespaceAttribute> _instance = new(() => new NoWhitespaceAttribute());
        public static NoWhitespaceAttribute Instance => _instance.Value;
        /// <inheritdoc/>
