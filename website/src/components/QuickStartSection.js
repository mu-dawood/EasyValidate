                            ...
                            <div className={styles.stepTips}>
                                {activeStep === 0 && (
                                    <div className={styles.tip}>
                                        ...
                                        <span>EasyValidate uses <code className={styles.inlineCode}>source generators</code> to create validation methods at compile-time for maximum performance.</span>
                                    </div>
                                )}
                                {activeStep === 1 && (
                                    <div className={styles.tip}>
                                        <span className={styles.tipIcon}>💡</span>
                                        <span>The <code className={styles.inlineCode}>partial</code> keyword is required for the source generator to add the validation method to your class.</span>
                                    </div>
                                )}
                                {activeStep === 2 && (
                                    <div className={styles.tip}>
                                        <span className={styles.tipIcon}>💡</span>
                                        <span>The <code className={styles.inlineCode}>Validate()</code> method is automatically generated and returns detailed error information for failed validations.</span>
                                    </div>
                                )}
                                {activeStep === 3 && (
                                    <div className={styles.tip}>
                                        <span className={styles.tipIcon}>💡</span>
                                        <span>Use the <code className={styles.inlineCode}>IsValid(memberName)</code> method to check the validity of specific members in your model.</span>
                                    </div>
                                )}
                                {activeStep === 4 && (
                                    <div className={styles.tip}>
                                        <span className={styles.tipIcon}>💡</span>
                                        <span>Utilize the <code className={styles.inlineCode}>HasErrors(memberName)</code> method to determine if there are any validation errors for a specific member.</span>
                                    </div>
                                )}
                            </div>
                        </div>
