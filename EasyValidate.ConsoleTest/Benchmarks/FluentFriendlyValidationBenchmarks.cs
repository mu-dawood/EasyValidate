...
namespace EasyValidate.Benchmarks
{
    ...
    public partial class FluentFriendlyValidationBenchmarks
    {
        ...
        [Benchmark]
        public Core.Abstraction.IValidationResult EasyValidate_ModifyThenValidate_Simple()
        {
            // Simulate modifying model values before validation
        ...
        [Benchmark]
        public Core.Abstraction.IValidationResult EasyValidate_ModifyThenValidate_Heavy()
        {
            // Simulate modifying model values before validation
